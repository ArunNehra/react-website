...
export function Footer() {
	return (
		<FooterContainer>
			<InnerContainer>
				<AboutContainer>
					<Logo bgColor="dark" color="white" />
					<AboutText>
						CarBazaar is car renting and selling company located in many
                ...
                <SectionContainer>
                    ...
                    <HorizontalContainer>
                        ...
                        <SmallText>+98-876-543-2112</SmallText>
                    </HorizontalContainer>
                </SectionContainer>
                <SectionContainer>
                    ...
                    <HorizontalContainer>
                        ...
                        <SmallText>info@carbazaar.com</SmallText>
                    </HorizontalContainer>
                </SectionContainer>
			</InnerContainer>
            <BottomContainer>
                <CopyrightText> Copyright &copy; {new Date().getFullYear()} CarBazaar. All rights reserved.</CopyrightText>
            </BottomContainer>
		</FooterContainer>
	);
}
